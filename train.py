...
parser.add_argument('--train_path', type=str, default='train_zalo.csv')
parser.add_argument('--dict_path', type=str, default="./PhoBERT_large_transformers/dict.txt")
parser.add_argument('--config_path', type=str, default="./PhoBERT_large_transformers/config.json")
parser.add_argument('--rdrsegmenter_path', type=str,default='/home/dinhmt/Project/News_Summarization/VnCoreNLP/VnCoreNLP-1.1.1.jar')
parser.add_argument('--pretrained_path', type=str, default='./PhoBERT_large_transformers/model.bin')
...
parser.add_argument('--bpe-codes', default="./PhoBERT_large_transformers/bpe.codes",type=str, help='path to fastBPE BPE')
...
for fold, (train_idx, val_idx) in enumerate(splits):
    ...
    for epoch in tq:
        ...
        for i,(x_batch, y_batch) in pbar:
            ...
            loss = criterion(y_pred.cuda(),y_batch.cuda())
            loss = loss.mean()
            loss.backward()
        ...
        best_th = 0
        score = f1_score(y[val_idx], val_preds, average='macro')
